...
const Main=()=>{
    ...
    const searchBook=(evt)=>{
        if(evt.key==="Enter"){
            axios.get('https://www.googleapis.com/books/v1/volumes?q='+search+'&key=AIzaSyCl4c6nW_doI8MIRWmbsjC_JHsMXrtS_Ys')
    ...
    <div className='header'>
       ...
       <div className='row2'>
        ...
        <div className='search'>
            <input type='text' placeholder='Enter The Name Of Book'
